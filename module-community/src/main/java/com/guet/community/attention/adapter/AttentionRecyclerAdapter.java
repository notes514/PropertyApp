package com.guet.community.attention.adapter;
...
import com.guet.community.attention.bean.AttentionCardViewModel;
import com.guet.community.databinding.CommunityItemAttentionCardViewBinding;
...
public class AttentionRecyclerAdapter extends BaseQuickAdapter<BaseCustomViewModel, BaseViewHolder> {
    ...
    protected void onItemViewHolderCreated(@NotNull BaseViewHolder viewHolder,
                                           int viewType) {
        CommunityItemAttentionCardViewBinding binding = DataBindingUtil.bind(viewHolder.itemView);
