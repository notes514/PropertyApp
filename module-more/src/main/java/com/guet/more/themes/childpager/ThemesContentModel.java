...
import com.guet.more.themes.childpager.bean.ThemesContent;
import com.guet.more.themes.childpager.bean.ThemesItemViewModel;
...
public class ThemesContentModel<T> extends BasePagingModel<T> {
    ...
    private void parseData(String s) {
        ...
        ThemesContent themesContent = GsonUtils.fromLocalJson(s, ThemesContent.class);
        if (themesContent != null) {
            ...
            for (ThemesContent.ItemListBean itemListBean : themesContent.getItemList()) {
                ...
                itemViewModel.description = itemListBean.getData().getDescription();
