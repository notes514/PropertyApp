...
public class SelectDialog extends Dialog implements OnClickListener,OnItemClickListener {
    ...
    private void initViews() {
        ...
        Button btnCancel = findViewById(R.id.mBtn_Cancel);
        TextView tvTitle = findViewById(R.id.mTv_Title);
        ...
        if(!TextUtils.isEmpty(mTitle) && tvTitle != null){
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!mUseCustomColor) {
                mFirstItemColor = mActivity.getResources().getColor(R.color.common_color_blue);
                mOtherItemColor = mActivity.getResources().getColor(R.color.common_color_blue);
            }
            if (1 == mStrings.size()) {
