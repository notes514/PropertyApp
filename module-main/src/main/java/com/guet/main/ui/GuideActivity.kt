...
import com.guet.main.bean.CustomBean
import com.guet.main.viewholder.CustomPageViewHolder
...
class GuideActivity : BaseDataActivity(), HolderCreator<CustomPageViewHolder> {
    ...
    private fun setupViewPager() {
        ...
        mViewPager.setAutoPlay(false)
                ...
                .setIndicatorColor(ContextCompat.getColor(this, R.color.common_color_white),
